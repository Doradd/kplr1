...
namespace ComplectPlus.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Positions = _context.Positions.Select(x => new SelectListItem() { Value = x.PositionId.ToString(), Text = x.PositionName }).ToList();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var rezult = await _userManager.AddToRoleAsync(user, "Guest");
