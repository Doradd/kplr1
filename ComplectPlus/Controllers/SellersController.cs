...
namespace ComplectPlus.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SellerId,SellerName,SellerUrName,SellerAdress")] Seller seller)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SellerId,SellerName,SellerUrName,SellerAdress")] Seller seller)
        {
