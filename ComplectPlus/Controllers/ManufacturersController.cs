...
namespace ComplectPlus.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ManufacturerId,ManufacturerName,ManufacturerPName")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManufacturerId,ManufacturerName,ManufacturerPName")] Manufacturer manufacturer)
        {
