    ...
    public class StoragesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Storages != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Storages'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("StorageId,ComponentId,Quantity")] Storage storage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StorageId,ComponentId,Quantity")] Storage storage)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Storages'  is null.");
            }
            var storage = await _context.Storages.FindAsync(id);
            if (storage != null)
            {
